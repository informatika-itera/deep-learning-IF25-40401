...
%	TITLE PAGE
%================================================
\title[short title]{Deep Learning (IF25-40401)} 
\subtitle{Pertemuan 4: CNN From Scratch}

\author[Surname]{Tim Dosen IF25-40401}
\institute[CBI]{Teknik Informatika \\ Institut Teknologi Sumatera}
...
\begin{frame}[plain]
    \begin{center}
        \vspace{3cm}
        {\Huge \textbf{Review: Neural Network}}
        \vspace{0.5cm}
        
        {\large Fondasi Deep Learning}
    \end{center}
\end{frame}
...
\begin{frame}[plain]
    \begin{center}
        \vspace{3cm}
        {\Huge \textbf{History of CNN}}
        \vspace{0.5cm}
        
        {\large Evolusi Convolutional Neural Network dari 1960s hingga Era Modern}
    \end{center}
\end{frame}
...
\begin{frame}[plain]
    \begin{center}
        \vspace{3cm}
        {\Huge \textbf{The CNN Architecture}}
        \vspace{0.5cm}
        
        {\large Convolutional, Pooling, Fully Connected Layers}
    \end{center}
\end{frame}
...
\begin{frame}[plain]
    \begin{center}
        \vspace{3cm}
        {\Huge \textbf{Perhitungan Matematis di CNN}}
        \vspace{0.5cm}
        
        {\large Memahami Operasi Konvolusi dan Pooling secara Matematis}
    \end{center}
\end{frame}
...
\begin{frame}[plain]
    \begin{center}
        \vspace{3cm}
        {\Huge \textbf{Membangun LeNet Architecture di PyTorch}}
        \vspace{0.5cm}
        
        {\large Implementasi CNN dari Awal menggunakan PyTorch}
    \end{center}
\end{frame}
